...
$routes = [
    ...
    '/admin/landing/create' => ['LandingSlideController', 'create'],
    '/admin/landing/edit' => ['LandingSlideController', 'edit'],
    '/admin/landing/delete' => ['LandingSlideController', 'delete'],
    '/admin/landing/toggle' => ['LandingSlideController', 'toggleStatus'],
    '/admin/landing/reorder' => ['LandingSlideController', 'reorder'],
